...
public class BookingForm extends JFrame {
    ...
    private void bookPackage() {
        ...
        try (Connection conn = DBConnection.getConnection()) {
            ...
            // Insert booking with payment_status = 'Unpaid'
            String sql = "INSERT INTO bookings (user_id, package_id, start_date, end_date, adults, children, hotel_preference, status, payment_status) " +
